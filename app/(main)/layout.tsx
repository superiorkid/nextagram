  ...
  return (
    <div className="flex min-h-screen space-x-7">
      <aside className="w-[18dvw] flex flex-col justify-between border-r border-gray-300 shadow-sm pt-12 pb-6 px-4">
        <div>
          <Logo className="h-[32px] flex items-start mb-8" />
          <nav className="flex flex-col space-y-2.5">
            <Link
              href="/"
              className="text-base font-bold hover:bg-gray-100 py-2.5 px-3 rounded-md"
            >
              <GoHomeFill className="w-7 h-7 inline mr-2.5" />
              Home
            </Link>
            <Link
              href="#search"
            ...
            >
              <GoSearch className="w-7 h-7 inline mr-2.5" />
              Search
            </Link>
            <Link
              href="#explore"
              className="text-base font-light hover:bg-gray-100 py-2.5 px-3 rounded-md"
            >
              <FiCompass className="w-7 h-7 inline mr-2.5" />
              Explore
            </Link>
            <Link
              href="#create-pop-up"
              className="text-base font-light hover:bg-gray-100 py-2.5 px-3 rounded-md"
            >
              <GoPlusCircle className="w-7 h-7 inline mr-2.5" />
              Create
            </Link>
            <Link
              href="#profile"
              className="text-base font-light hover:bg-gray-100 py-2.5 px-3 rounded-md"
            >
              <RxAvatar className="w-7 h-7 inline mr-2.5" />
              Profile
            </Link>
          </nav>
        </div>
